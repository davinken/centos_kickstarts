...
# WARNING: Disk name is for KVM VM instances: vda instead of sda.
# Typical 150 GB+
# REV. 2016-11-10 David Ramirez 
...
%include /ksincludes/icos7partitioning_midvm.ks
